function [recreatedImg] = optimizedDatabase1(Img, img_lab, im_resized)
...
%% optimize database by delteing objects "close" to each other
    ...
    [optimizedDataBaseLab,optimizedDataBaseRGB] = optimizeDataBase2func(MeanImage, img_lab,im_resized ,MeanImageTiles);
